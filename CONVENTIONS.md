...
Conventions are subject to change, such as to make necessary exceptions for keeping code clean.
...
- [`net.minecraft.item.Item`](./mappings/net/minecraft/item/Item.mapping)'s Item declarations should use `UPPER_SNAKE_CASE`
   to match [`net.minecraft.block.Block`](./mappings/net/minecraft/block/Block.mapping)'s Block declarations,
   and avoid a mess of mixed cases.
